...
@Service
public class CalculateSolarSistemOffGridService {

    private static final Logger log = LoggerFactory.getLogger(CalculateSolarSistemOffGridService.class);
...
//SolarPanelRepository repository, preciso impelentar para trazer dados do banco de dados
    public CalculateSolarSistemOffGridService(
    ...
    public ResponseSistemSolarOffGridComplete calculateSitemSolarComplete(RequestCalculateSistemSolarComplete request){
        ...
        */
        ...
        return new ResponseSistemSolarOffGridComplete(
            req.city(),
            totalLoad,
