...
public class CaculateBatteryBankImpl implements CalculateBatteryBankInterface {
    ...
    public Integer numberOfBatteriesInsires(
        ...
        return (voltagyBatteryBank / voltagyBattery);
    }
    ...
    public double numberOfBatteriesParallel(Integer batteryBankCapacityReal, Double capacityBateryAH) {
        return (batteryBankCapacityReal / capacityBateryAH);
    }

    @Override
    // dimenciona o numero total de bateria para montagem do banco de bateria
    public double numberTotalOfBattty(Integer numberOfBatteriesInsires, double numberOfBatteriesParallel) {
