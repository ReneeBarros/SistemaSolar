...
public class CalculateSistemLoad {
   ...
   private final OffGridCalculateInterface offgrid;
    ...
    public ResponseSistemLoad caculateSistemLoad( RequestOffGrid request,Double inversorEficient,Double globalRediment ){
        ...
        Double geralenergyRequired = Double.valueOf(String.format("%.2f", offgrid.GeralenergyRequired(globalRediment, correctedEnergyDay)).replace(",",".")) ;
